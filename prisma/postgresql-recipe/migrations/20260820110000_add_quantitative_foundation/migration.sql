...
CREATE TABLE "immos_recipe_phase8"."quantitative_stock_positions" (
  "id" text NOT NULL,
  ...
  CONSTRAINT "quantitative_stock_positions_asset_entry_id_fkey"
    FOREIGN KEY ("asset_entry_id") REFERENCES "immos_recipe_phase8"."asset_entries"("id") ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT "quantitative_stock_positions_location_id_fkey"
    FOREIGN KEY ("location_id") REFERENCES "immos_recipe_phase8"."locations"("id") ON DELETE RESTRICT ON UPDATE CASCADE
);

CREATE INDEX "quantitative_stock_positions_asset_entry_id_idx"
  ON "immos_recipe_phase8"."quantitative_stock_positions"("asset_entry_id");
CREATE INDEX "quantitative_stock_positions_location_id_idx"
  ON "immos_recipe_phase8"."quantitative_stock_positions"("location_id");

CREATE TABLE "immos_recipe_phase8"."quantitative_movement_lines" (
  "id" text NOT NULL,
  ...
  CONSTRAINT "quantitative_movement_lines_movement_id_fkey"
    FOREIGN KEY ("movement_id") REFERENCES "immos_recipe_phase8"."asset_movements"("id") ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT "quantitative_movement_lines_asset_entry_id_fkey"
    FOREIGN KEY ("asset_entry_id") REFERENCES "immos_recipe_phase8"."asset_entries"("id") ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT "quantitative_movement_lines_from_location_id_fkey"
    FOREIGN KEY ("from_location_id") REFERENCES "immos_recipe_phase8"."locations"("id") ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT "quantitative_movement_lines_to_location_id_fkey"
    FOREIGN KEY ("to_location_id") REFERENCES "immos_recipe_phase8"."locations"("id") ON DELETE RESTRICT ON UPDATE CASCADE
);

CREATE INDEX "quantitative_movement_lines_movement_id_idx"
  ON "immos_recipe_phase8"."quantitative_movement_lines"("movement_id");
CREATE INDEX "quantitative_movement_lines_asset_entry_id_idx"
  ON "immos_recipe_phase8"."quantitative_movement_lines"("asset_entry_id");
CREATE INDEX "quantitative_movement_lines_from_location_id_idx"
  ON "immos_recipe_phase8"."quantitative_movement_lines"("from_location_id");
CREATE INDEX "quantitative_movement_lines_to_location_id_idx"
  ON "immos_recipe_phase8"."quantitative_movement_lines"("to_location_id");
