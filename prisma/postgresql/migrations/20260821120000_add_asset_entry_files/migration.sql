...
CREATE TYPE "immos"."AssetFileKind" AS ENUM ('MATERIAL_PHOTO', 'SUPPORTING_DOCUMENT');

ALTER TABLE "immos"."asset_files"
  ALTER COLUMN "asset_unit_id" DROP NOT NULL,
  ADD COLUMN "asset_entry_id" text,
  ADD COLUMN "file_kind" "immos"."AssetFileKind";
...
ALTER TABLE "immos"."asset_files"
  ...
  ADD CONSTRAINT "asset_files_asset_entry_id_fkey"
    FOREIGN KEY ("asset_entry_id") REFERENCES "immos"."asset_entries"("id")
    ON DELETE RESTRICT ON UPDATE CASCADE;

CREATE INDEX "asset_files_asset_entry_id_idx"
  ON "immos"."asset_files"("asset_entry_id");
